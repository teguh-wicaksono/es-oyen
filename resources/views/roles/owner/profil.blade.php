@extends('layouts.wana', ['title' => 'Profil Owner | Wana Cafe'])
...
@section('content')
    <section class="page-head profile-head">
        <div>
            ...
            <h1>Profil Owner</h1>
            <p class="lead">Data akun owner digunakan untuk login dan mengelola operasional cafe.</p>
        </div>
    </section>
    ...
    <div class="profile-shell">
        <div class="panel profile-card simple-profile">
            ...
            <div class="account-note">
                Akun owner memiliki akses penuh untuk mengelola laporan, stok, produk, dan karyawan.
            </div>

            <a class="btn ghost" href="{{ route('owner.karyawan') }}">Kelola Karyawan</a>
